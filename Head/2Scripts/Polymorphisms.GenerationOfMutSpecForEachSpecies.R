...
### neutral ATGC
NeutralATGC = read.table('../../Body/3Results/Polymorphisms.Normalization.NeutralATGC.txt', header = TRUE, sep='\t')
...
write.table(MUT, '../../Body/3Results/Polymorphisms.MutSpecData.txt', quote = FALSE, row.names = FALSE)
