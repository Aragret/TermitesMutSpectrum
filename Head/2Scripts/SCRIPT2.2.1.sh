...
~/bin/tblastn -db ~/termits/1Raw/All.unique.fa -db_gencode 5 -num_alignments 500 -query query.fa -out query.out-mitocode 1>/dev/null 2>/dev/null
...
~/bin/nuc_coding_mod2.pl query.out-mitocode_sel.hash ~/termits/1Raw/All.unique.fa 1>query.out-mitocode_sel.nuc 2>/dev/null
