...
NormFrac = read.table("../../Body/3Results/Cockroaches.Polymorphisms.Normalization.Normalized12Fractions.txt", header = TRUE)


pdf("../../Body/4Figures/Cockroaches.Polymorphisms.Normalization.R.03.Bars.pdf", width = 15, height = 10)
